...
<div className="justify-center items-center flex"> 
  ...
  <div className="rounded-lg bg-weather w-night-800 h-night-1200 top-40 left-36  z-10 flex justify-center  items-center "> 
    ...
    <div className="  bg-white bg-opacity-75 h-city w-city justify-self-center align-self justify-center items-center flex rounded-xl relative" >
     <div className="  text-black bg-custom-gradient bg-clip-text text-transparent absolute font-bold text-city top-cityTop left-cityLeft ">{weather.name}</div> 
     <h1 className=" text-9xl absolute font-bold  bottom-temp left-10 bg-gradient-to-r from-slate-400 via-slate-800 to-slate-900 bg-clip-text text-transparent"> {Math.round(weather.main.temp)}°C</h1>
     <div className="text-mood font-bold text-moods bottom-moodBottom left-moodLeft absolute">{weather.weather[0].main}</div>
